...
from D_0822_envClass import EnvInfo as EI
from D_0822_envClass import CanInfo as CI
        ...
        while 1:    # this while loop is for the algorithm
            ...
            if len(t_cf[0]) >= len(env.ore_order):
                ...
                while 1:
                    ...
                    # for i in range(len(in_can_info)):
                    #     print i, "A:", in_can_info[i].A, "B:", in_can_info[i].BT
