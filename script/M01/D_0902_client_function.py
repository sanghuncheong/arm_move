...
def move_goalpose_client(arm_name, hand_name, start_state, goal_pos, goal_ori, obj, planner_name, n_attempt, c_time, n_repeat):
    ...
    try:
        ...
        if resp_f_check.feasibility == 1:
            if len(resp_f_check.r_trj.joint_trajectory.points) > 0 and len(resp_f_check.r_trj.joint_trajectory.points) < 95:
...
def det_box_client_191204(box_name, box_xyz, box_xyzw, box_wdh, box_color):
    import rospy
    from arm_move.srv._box_info_srv import *
