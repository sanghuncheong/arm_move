...
def influence(ob, target, obstacle, Body_position, d_max, ob_radius, target_radius):
    ...
    for i in range(ob):#여기가 문제. i=10, j=5일때, ob 중에 세번째 i = 2 (0, 2, 4 순서니까 4번 물체)에서 h=1이 나와야하는데 안나옴.
