...
from D_0823_envClass4altest import EnvInfo as EI
from D_0823_envClass4altest import CanInfo as CI
...
if __name__ == '__main__':
    ...
    for n_obs_max in range(12, 15+1):
            ...
            while env.order_error_flag:
                ...
                while 1:    # this while loop is for the algorithm
                    ...
                    if len(t_cf[0]) >= len(env.ore_order):
                        ...
                        order_cnt = order_cnt + 100*len(t_cp)
                        # print "\n"
                        # for i in range(len(t_cp)):
                        #     print "cp", t_cp[i].pos, "\nc_ore", c_ore[i]
